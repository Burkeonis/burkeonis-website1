...
export default function Home() {
  return (
    <main>
      ...
      <footer><div className="shell footer-grid"><div><a className="wordmark" href="#top">BURKEONIS</a><p>I made something out of the mess.</p><a href="mailto:hello@burkeonis.com">hello@burkeonis.com</a><a href="https://instagram.com/realburkeonis" target="_blank" rel="noopener">Instagram</a><a href="https://youtube.com/@Burkeonis" target="_blank" rel="noopener">YouTube</a><a href="https://www.facebook.com/profile.php?id=61582733247444" target="_blank" rel="noopener">Facebook</a></div><div><strong>Navigate</strong><a href="#mirror">Self Mirror</a><a href="#tools">Tools</a><a href="#music">Music</a><a href="#last-words">No Last Words</a></div><div><strong>Explore</strong><a href="/shadow-work">Shadow Work</a><a href="/misophonia">Misophonia</a><a href="/rad">Adults with RAD</a><a href="/about">About</a><a href="/blog">Blog</a><a href="/first-pattern-file">Free Pattern File</a></div><div><strong>Legal</strong><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/disclaimer">Disclaimer</a><a href="/refund">Refunds</a></div></div><div className="shell copyright">© 2026 BURKEONIS. ALL RIGHTS RESERVED.</div></footer>
    </main>
  );
}
